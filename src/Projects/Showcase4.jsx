            ...
            <div className="card flex-shrink-0 w-full max-w-sm">
                <div className="card-body">
                    ...
                    <div className='mt-2 flex items-center justify-between'>
                        <button className='btn' onClick={() => window.open('https://spontaneous-llama-74f2a0.netlify.app/', '_blank')}>Live Site</button>
                        <button className='btn btn-circle' onClick={() => window.open('https://github.com/iqbalhossensorkar/dev-jobs', '_blank')}><FaGithub /></button>
                    </div>
                </div>
            </div>
